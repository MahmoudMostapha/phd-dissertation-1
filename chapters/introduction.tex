...
%% - This is what growth is and these are the sorts of things that affect
%% it. (e.g. fig)
%% - We're interested in growth in a particular class of tissues, because
%% of the potential medical implications
%% - But the physics involved in these processes are complex and we began
...
%% - We're working on a continuum scale because we believe it provides a
...
%% - Our first take, 5 years ago, stemmed from classical theories for
%% the mechanics of solids. Chapter 2 discusses this approach and Chapter
%% 3 computes with it.
%% - Talk about the contributions of this approach.
