...
by decomposing the total solid stress into two parts, a ``passive''
stress associated with the hyperelastic response of the ECM, and an
``active'' stress, associated with the cell traction forces on the
surrounding medium:
