...
mechanical (stress) effects. A single solute species\footnote{Here, we
  ...
  growth by catalysing biochemical reactions. An important
...
% Note: Perhaps the unbounded flow figures can be snuck in around
% here.
...
calculation, the reaction rate, $k^\mathrm{f}$, is 0.07
$\mathrm{s}^{-1}$.
