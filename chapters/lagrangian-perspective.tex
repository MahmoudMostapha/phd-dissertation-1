...
\noindent Applying Leibniz's product rule to the last term and using
the mass balance equation (\ref{localbalanceofmass}) gives
...
rule and Gauss' divergence theorem (Appendix~\ref{gauss-divergence})
gives
...
and Gauss' divergence theorem (Appendix~\ref{gauss-divergence}),
giving first,
