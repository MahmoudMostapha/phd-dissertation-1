...
\psfrag{WT}{\small$\Omega_t$}
       {\includegraphics[width=14cm]{images/elucidation/growth1.eps}}
       \caption{The continuum body with diffusing species and under
         stress.}\label{potato} 
\end{figure}
...
\begin{figure}[ht]
  ...
  \psfrag{I}{\small$\bn\cdot\bm^\iota$}
	 {\includegraphics[width=10.00cm]
           {images/elucidation/cp-mass-solute.eps}}
...
{\includegraphics[width=15cm]
  {images/elucidation/kinematics.eps}}
...
\begin{figure}[ht]
  ...
  \psfrag{N}{\small $\Bvarphi$}
         {\includegraphics[width=10.00cm]{images/elucidation/kinematics.eps}}
...
{\includegraphics[width=10.00cm]{images/elucidation/composite.eps}}
...
\psfrag{o}{\small$\bN_2$}
\psfrag{p}{\small$\bN_3$}
\centering {\includegraphics[width=10.00cm]{images/elucidation/wlcm-cuboid.eps}}
...
\includegraphics[width=10.00cm]{images/elucidation/saturation.eps}
...
\begin{figure}
\centering
\includegraphics[width=10.00cm]{images/elucidation/concentration.eps}
