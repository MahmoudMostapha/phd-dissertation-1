...
\begin{figure}
  ...
  \includegraphics[width=0.8\textwidth]{images/elucidation/cp-mass}
...
\emph{fluid} species, denoted by $\mathrm{f}$, consisting
primarily of water, and \emph{solute} species, consisting of
precursors to reactions, byproducts, nutrients, and other regulatory
chemicals. A generic solute will be denoted by $\mathrm{s}$. In the
treatment that follows, an arbitrary species will be denoted by
$\iota$, where $\iota = \mathrm{c,f,s}$.
...
\begin{figure}[ht]
  ...
  \psfrag{I}{\small$\bn\cdot\bm^\iota$}
  \psfrag{J}{\small$\bg$}
  \psfrag{K}{\small$\bq^\iota$}
  \psfrag{L}{\small$\bP^\iota\bN$}
  \psfrag{O}{\small$\Bsigma^\iota\bn$}
...
Written in integral form, the balance of momentum of species $\iota$
over $\Omega_0$ is, 
...
\begin{figure}[ht]
  \centering
  \psfrag{A}{\small$\bX$}
  \psfrag{B}{\renewcommand{\baselinestretch}{1.5}\small$r^\iota$}
  \psfrag{E}{\small$\Bvarphi$}
  \psfrag{C}{\small$\Omega_0$}
  \psfrag{L}{\small$\bP\bN$}
  \psfrag{K}{\small$\tilde{e}^\iota$}
  \psfrag{D}{\small$\bN\cdot\bQ$}
...
Figure~\ref{saturation-and-swelling} schematically depicts two possible
