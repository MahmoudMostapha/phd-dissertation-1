...
\begin{figure}
  ...
  \psfrag{G}{$\pi^\iota$} \psfrag{E}{$\Bvarphi$}
  \psfrag{C}{$\Omega_0$} \psfrag{H}{$\Omega_t$}
  \psfrag{D}{$\bN\cdot\bM^\iota$} \psfrag{I}{$\bn\cdot\bm^\iota$}
...
%% Todo: Some nicer entrance goes here. Until this point, the
