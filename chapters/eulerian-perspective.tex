...
% Even though this way of looking at the system results in a set of
% differential equations entirely compatible (just pushed-forward to
% the current configuration) set of differential equations to those
% arrived-at in Chapter 3, it serves a useful purpose in clarifying
% what quantities are primal and what sorts of boundary conditions
