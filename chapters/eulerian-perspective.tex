...
A sufficient condition to satisfy a portion of the above inequality is
to specify the following form for the mass flux of each species s,
...
\noindent where $\bD^{\mathrm{s}}$ is a positive semi-definite
mobility, and Equation~(\ref{eu-diffusive-flux}) results in classical
diffusive flux of the solute species when their Helmholtz free
energies are purely a function of their concentrations.
