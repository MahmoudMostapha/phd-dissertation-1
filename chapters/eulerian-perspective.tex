...
\subsection{Species energy-dependent mass source terms}
...
solute are fundamentally different constituents, we turn to the
...
\cdot \bv^{\mathrm{f}}$, in Section~(\ref{eu-interaction%
  -foces}). Now, we turn our attention to the remaining portion of the
dissipation inequality for the fluid:
...
tensor in terms of its pressure and rate of deformation tensor,
$\bd^{\mathrm{f}}$, as:
...
\subsection{Source-based solute velocities}
