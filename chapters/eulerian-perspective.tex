...
biological tissue which ensure that the Clausius-Duhem
inequality~(\ref{eu-clausiusduhemform}) is satisfied a priori.

% We will be reintroducing the species classification and will take
% apart the equation term by term, seeing what it implies. 
...
Mention the fact that not all aspects of time-dependent response can
be gathered from poroelasticity alone, and so we generalise the theory
to account for a viscoelastic solid.
