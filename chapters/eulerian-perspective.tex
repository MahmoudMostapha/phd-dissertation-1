...
\citet{ateshian07}). One then proceeds to consider a scenario where
the functional forms of some of the terms in the dissipation
...
In practice, the two approaches outlined above are equivalent, and the
former is employed in the following treatment.
