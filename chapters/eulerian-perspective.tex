...
% And it is for this reason that the entire treatment is for an
% arbitrary species~$\iota$ and specialisations to c, f, s are only
% introduced when talking about constitutive relationships specific to
% the different constituents of the tissue.
...
% Which, in words, states that the only kinds of chemical interactions
% allowed in the formulation are those in which the mass of species
% get converted between each other; similar to the law of mass action?

%i.e., the formulation
% doesn't allow overall system momentum production at a point.
...
% Which states, in words that the momentum being created at a point
% due to creation of matter has to be countered by the momentum
% interaction arising from other species. i.e., the formulation
% doesn't allow overall system momentum production at a point.
