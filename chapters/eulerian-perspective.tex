...
(\ref{eu-summationrelationeneergy})), stems from a formally stated
...
external observers can quantify the mass of a species within a system
...
+ \underbrace{\int_{\partial \Omega_{t}}
  \bp \times \left(\Bsigma^{\iota}\cdot\bn\right)\ da}_{\text{Moment
    from traction}}\\  
